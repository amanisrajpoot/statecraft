      ...
      <div className="inner-banner-three text-center p-30">
        ...
        >
          <div className="container">
            ...
            The pioneer IAS coaching institute located in Vijayanagar, Bangalore.
            </p>
          </div>
          {/* End container */}
        </div>
              ...
              <div className="col-lg-4" data-aos="fade-right">
                <div className="title-style-one mt-30">
                  ...
                  <h2 className="main-title fw-bold tx-dark">
                    Why <span>choose</span> StateCraft IAS Academy.
                  </h2>
                </div>
                {/* /.title-style-one */}
                <p className="text-lg mt-40 lg-mt-20">
                  Our unique pattern of extracting current affairs, small batches, and detail-oriented approach makes us stand unique compared to the other UPSC coaching in Bangalore.
                </p>
                <Image
                  width={73}
                  height={75}
